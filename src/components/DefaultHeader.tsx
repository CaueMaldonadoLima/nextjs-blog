    ...
    return (
            <div className="w-full bg-lightBg dark:bg-darkBg shadow-lg">
                <div className="w-full py-6 px-4 sm:px-16 space-x-4 bg-white text-lightText dark:text-darkText font-medium flex">
                    <div className="w-[80%] flex items-center justify-beetween md:justify-normal">
                        <span className="mr-6 text-lg font-bold text-lightText dark:text-darkText">{showHeaderText? 'Cauê Maldonado' : 'Cauê M.'}</span>
                    {showHeaderItems? <>
                        <Link href={'/'} 
                        ...
                        {(!showHeaderItems && dropDownOpen) && 
                            <div className="absolute top-[92px]   rounded shadow-md flex flex-col bg-lightBg dark:bg-darkBg">
