        ...
        <>
			<div className="flex-col w-full h-auto justify-center px-4 sm:px-32 lg:px-56 py-8 text-lightText dark:text-darkText">
                <span className="w-full justify-center flex font-semibold text-lg text-lightText dark:text-darkText mb-4">Projects</span>
                    ...
                    <span>
                        {"Here's where you can find all my projects"}
                    </span>
                <div className='w-full border-t border-primaryPurple dark:border-lightText border-opacity-30 py-6 mt-8'>
                    <div className='p-4 rounded-md shadow-lg shadow-black my-2 bg-darkBg bg-opacity-[0.025] dark:bg-lightBg dark:bg-opacity-[0.025]'>
                        ...
                        <p>
                            {"It's a blog-like web application where you can find some information about me."}
                        </p>
                        <MoreInfoComponent>
                            <div className='w-full flex-col justify-start items-start text-start rounded-md shadow-xl p-2 border bg-lightBg dark:bg-darkBg border-primaryPurple dark:border-secondaryPurple'>
                                <ul>
