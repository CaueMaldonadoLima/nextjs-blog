        ...
        <>
			<div className="flex-col w-full h-auto justify-center px-32 lg:px-56 py-8 text-lightText dark:text-darkText">
                ...
                <div className='w-full border-t border-primaryPurple dark:border-lightText border-opacity-30 py-6 mt-8'>
                    <div className='p-4 rounded-md w-full shadow-lg shadow-black bg-darkBg dark:bg-lightBg bg-opacity-[0.025] dark:bg-opacity-[0.025]'>
                        ...
                        <MoreInfoComponent>
                            <div className='w-full flex-col bg-lightBg dark:bg-darkBg justify-start items-start text-start rounded-md shadow-xl p-2 border border-primaryPurple dark:border-secondaryPurple'>
                                <ul>
